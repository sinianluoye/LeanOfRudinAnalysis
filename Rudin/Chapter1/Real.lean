...
private theorem gtz_then_ex_gtz_natRoot_lemma_1 {x:RR} {n:Nat} {E: Set RR}
  (hE: E = {t:RR | t ^ n < x})
  (hx: x > 0)
  (hn: n > 1): E ≠ ∅ := by
  simp [Set.not_empty_iff_ex_mem]
...
private theorem gtz_then_ex_gtz_natRoot_lemma_2 {x:RR} {n:Nat} {E: Set RR}
  (hE: E = {t:RR | t ^ n < x})
  (hx: x > 0)
...
private theorem gtz_then_ex_gtz_natRoot_lemma_3 {y x:RR} {n:Nat}
  (hy: ExistsSup {t:RR | t ^ n < x} y)
  (hn: n > 1)
  (hx: x > 0):
  y > 0
  := by
...
private theorem gtz_then_ex_gtz_natRoot_lemma_4 {y h x:RR} {n:Nat}
  (hn: n > 1)
  (hx: x > 0)
  (hy: ExistsSup {t:RR | t ^ n < x} y)
  (h0: 0 < h)
...
private theorem gtz_then_ex_gtz_natRoot_lemma_5 {x y:RR} {n:Nat}
  (hx: x > 0)
  (hn: n > 1)
  (hy: ExistsSup {t:RR | t ^ n < x} y)
  (hxy : y^n < x)
...
private theorem gtz_then_ex_gtz_natRoot_lemma_6 {x y k:RR} {n:Nat}
  (hx: x > 0)
  (hn: n > 1)
  (hy: ExistsSup {t:RR | t ^ n < x} y)
  (hxy : x < y^n)
  ...
  have hky : k < y := by
    ...
    linarith
    exact h1
  have h_up : UpperBound {t:RR | t ^ n < x} (y - k) := by
    simp [UpperBound]
    intro t ht
    contrapose! ht
